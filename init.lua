...
-- able to move lines in visual mode with "J" and "K"
vim.keymap.set('v', 'J', ":m '>+1<CR>gv=gv", { desc = 'move line up with J in visual mode' })
vim.keymap.set('v', 'K', ":m '<-2<CR>gv=gv", { desc = 'move line up with J in visual mode' })
